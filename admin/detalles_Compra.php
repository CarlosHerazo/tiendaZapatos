...
<main>
    <div class="container-fluid">
        ...
        <section class="container-fluid">
            ...
            <table id="tablaCompra_detalles" class="table table-striped table-bordered nowrap text-center" style="width:100%">
                <thead>
...
<script>
    $(document).ready(function() {
        ...
        let table = $("#tablaCompra_detalles").DataTable({
            "ajax": {
        ...
        $('#tablaCompra_detalles tbody').on('click', '.btnEliminar', function() {
